.class public Lcom/test/seal/overlay;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/test/seal/overlay;->timeout:I
...
.method private areBlackListAppsInstalled()Ljava/lang/String;
    ...
    .line 77
    invoke-virtual {p0}, Lcom/test/seal/overlay;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-direct {p0, v3}, Lcom/test/seal/overlay;->isApplicationBlackListed(Ljava/lang/String;)Z
...
.method private isApplicationBlackListed(Ljava/lang/String;)Z
    ...
    .line 67
    invoke-direct {p0}, Lcom/test/seal/overlay;->loadBlackListAppList()Ljava/util/List;
...
.method private isEmulator()Z
    ...
    .line 128
    invoke-direct {p0}, Lcom/test/seal/overlay;->checkVirtualBox()Z
...
.method private showAlertDialogAndExitApp(Ljava/lang/String;)V
    ...
    .line 54
    new-instance v1, Lcom/test/seal/overlay$$ExternalSyntheticLambda1;

    invoke-direct {v1, p0}, Lcom/test/seal/overlay$$ExternalSyntheticLambda1;-><init>(Lcom/test/seal/overlay;)V
...
.method public isDeveloperModeEnabled()Z
    ...
    .line 62
    invoke-virtual {p0}, Lcom/test/seal/overlay;->getApplicationContext()Landroid/content/Context;
...
.method synthetic lambda$onCreate$0$com-test-seal-overlay()V
    .locals 2

    .line 42
    new-instance v0, Landroid/content/Intent;

    const-class v1, Lcom/test/seal/MainActivity;

    invoke-direct {v0, p0, v1}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    .line 43
    .local v0, "i":Landroid/content/Intent;
    invoke-virtual {p0, v0}, Lcom/test/seal/overlay;->startActivity(Landroid/content/Intent;)V

    .line 44
    invoke-virtual {p0}, Lcom/test/seal/overlay;->finish()V

    .line 45
    return-void
.end method

.method synthetic lambda$showAlertDialogAndExitApp$1$com-test-seal-overlay(Landroid/content/DialogInterface;I)V
    .locals 0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/test/seal/overlay;->areBlackListAppsInstalled()Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, Lcom/test/seal/overlay;->showAlertDialogAndExitApp(Ljava/lang/String;)V
    ...
    .line 32
    const-string v2, "Android Debugger is connected! Exiting App"
    ...
    .line 35
    :cond_2
    invoke-virtual {p0}, Lcom/test/seal/overlay;->isDeveloperModeEnabled()Z
    ...
    .line 37
    :cond_3
    invoke-direct {p0}, Lcom/test/seal/overlay;->isEmulator()Z
    ...
    new-instance v3, Lcom/test/seal/overlay$$ExternalSyntheticLambda0;

    invoke-direct {v3, p0}, Lcom/test/seal/overlay$$ExternalSyntheticLambda0;-><init>(Lcom/test/seal/overlay;)V

    iget v4, p0, Lcom/test/seal/overlay;->timeout:I
